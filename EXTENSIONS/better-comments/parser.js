...
class Parser {
    ...
    setTags() {
        ...
        for (let item of items) {
            ...
            let optionsIn = { color: item.backgroundColor, backgroundColor: item.backgroundColor };
            // ? the textDecoration is initialised to empty so we can concat a preceeding space on it
            options.textDecoration = "";
            optionsIn.textDecorationIn = "";
            if (item.strikethrough) {
                options.textDecoration += "line-through";
                optionsIn.textDecoration += "line-through";
            }
            if (item.underline) {
                options.textDecoration += " underline";
                optionsIn.textDecoration += " underline";
            }
            if (item.bold) {
                options.fontWeight = "bold";
                optionsIn.fontWeight = "bold";
            }
            if (item.italic) {
                options.fontStyle = "italic";
                optionsIn.fontStyle = "italic";
            }
